 ...
 * V2.x with 5v excitation (AVR) 21 : Pt100 with circuit in the Ultimainboard
 * V2.x with 3.3v excitation (STM32 \ LPC176x....) 201 : Pt100 with circuit in
 * Overlord, similar to Ultimainboard V2.x 60 : 100k Maker's Tool Works Kapton
 * Bed Thermistor beta=3950 61 : 100k Formbot / Vivedino 3950 350C
...
//'M303 D' to toggle activation. #define PID_OPENLOOP 1        // Puts PID in
...
#define NEOPIXEL_PIXELS \
  30  // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips
      // are used
