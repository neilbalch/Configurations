...
- 3D Printing
  - `Ender 3 Marlin-1.1.x.zip` Customized [MarlinFW](https://www.marlinfw.org) v1.1 firmware for Ender 3
  - Cura
...
- Drones
  - `Betaflight F405-CTR Dumps` Dated Betaflight FC config dumps on [Matek F405-CTR](https://www.mateksys.com/?portfolio=f405-ctr)
  - `MultiWii_Flip.zip` [Customised MultiWii](https://www.multiwii.com/wiki/?title=Main_Page) FC firmware for [RTFQ Flip MWC](https://readytoflyquads.com/flip-mwc-flight-controller)
- Games
  - FlightGear
...
- Firefox
  - `[profile]/chrome/userChrome.css` Hides the tabbar and sidebar header for use with [Tree Style Tab](https://www.addons.mozilla.org/en-US/firefox/addon/tree-style-tab/)
